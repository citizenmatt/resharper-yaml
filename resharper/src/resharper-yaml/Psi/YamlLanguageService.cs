...
namespace JetBrains.ReSharper.Plugins.Yaml.Psi
{
  ...
  public class YamlLanguageService : LanguageService
  {
    ...
    public YamlLanguageService([NotNull] PsiLanguageType psiLanguageType, [NotNull] IConstantValueService constantValueService, CommonIdentifierIntern intern)
    ...
    {
      return new YamlParser(lexer as ILexer<int> ?? lexer.ToCachingLexer(), myIntern);
    }
