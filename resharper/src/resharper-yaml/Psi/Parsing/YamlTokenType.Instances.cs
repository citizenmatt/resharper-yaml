...
namespace JetBrains.ReSharper.Plugins.Yaml.Psi.Parsing
{
  public static partial class YamlTokenType
  {
    ...
    public static readonly TokenNodeType NS_PLAIN = new GenericTokenNodeType("NS_PLAIN", LAST_GENERATED_TOKEN_TYPE_INDEX + 34, "NS_PLAIN");
    public static readonly TokenNodeType NS_ANCHOR_NAME = new GenericTokenNodeType("NS_ANCHOR_NAME", LAST_GENERATED_TOKEN_TYPE_INDEX + 35, "NS_ANCHOR_NAME");
    public static readonly TokenNodeType C_SINGLE_QUOTED_SINGLE_LINE = new GenericTokenNodeType("C_SINGLE_QUOTED_SINGLE_LINE", LAST_GENERATED_TOKEN_TYPE_INDEX + 36, "C_SINGLE_QUOTED_SINGLE_LINE");
    public static readonly TokenNodeType C_SINGLE_QUOTED_MULTILINE = new GenericTokenNodeType("C_SINGLE_QUOTED_MULTILINE", LAST_GENERATED_TOKEN_TYPE_INDEX + 37, "C_SINGLE_QUOTED_MULTILINE");
