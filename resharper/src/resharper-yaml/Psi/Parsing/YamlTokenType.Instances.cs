...
namespace JetBrains.ReSharper.Plugins.Yaml.Psi.Parsing
{
  public static partial class YamlTokenType
  {
    ...
    public static readonly TokenNodeType NS_URI_CHARS = new GenericTokenNodeType("NS_URI_CHARS", LAST_GENERATED_TOKEN_TYPE_INDEX + 20, "NS_URI_CHARS");
    public static readonly TokenNodeType NS_TAG_CHARS = new GenericTokenNodeType("NS_TAG_CHARS", LAST_GENERATED_TOKEN_TYPE_INDEX + 21, "NS_TAG_CHARS");
    public static readonly TokenNodeType NS_PLAIN = new GenericTokenNodeType("NS_PLAIN", LAST_GENERATED_TOKEN_TYPE_INDEX + 22, "NS_PLAIN");
    public static readonly TokenNodeType NS_ANCHOR_NAME = new GenericTokenNodeType("NS_ANCHOR_NAME", LAST_GENERATED_TOKEN_TYPE_INDEX + 23, "NS_ANCHOR_NAME");
    public static readonly TokenNodeType C_SINGLE_QUOTED = new GenericTokenNodeType("C_SINGLE_QUOTED", LAST_GENERATED_TOKEN_TYPE_INDEX + 24, "C_SINGLE_QUOTED");
    public static readonly TokenNodeType C_DOUBLE_QUOTED = new GenericTokenNodeType("C_DOUBLE_QUOTED", LAST_GENERATED_TOKEN_TYPE_INDEX + 25, "C_DOUBLE_QUOTED");
  }
}
