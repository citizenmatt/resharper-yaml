...
namespace JetBrains.ReSharper.Plugins.Yaml.Psi.Parsing
{
  public static partial class YamlTokenType
  {
    ...
    public const int NS_PLAIN_MULTI_LINE_NODE_TYPE_INDEX = LAST_GENERATED_TOKEN_TYPE_INDEX + 7;
    public const int NS_PLAIN_ONE_LINE_NODE_TYPE_INDEX = LAST_GENERATED_TOKEN_TYPE_INDEX + 8;
    ...
    public static readonly TokenNodeType INDENT = new GenericTokenNodeType("INDENT", LAST_GENERATED_TOKEN_TYPE_INDEX + 24, "INDENT");
